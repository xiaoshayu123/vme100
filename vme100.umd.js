(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vme100 = {}, global.axios));
    ...
    axios__default["default"].post('http://43.138.126.219:8000/api/jserror/new',log).then(res=>{
            console.log(res);
                }); 
       ...
       window.addEventListener('unhandledrejection',function(event){
        ...
        let data={
            ...
            ...log
              ...
              axios__default["default"].post('http://43.138.126.219:8000/api/promiseerror/new',data).then(res=>{
            console.log(res);
                }); 
            ...
            if(this.logData)
            {
                ...
                let handler=(type)=>(event)=>{
                   ...
                   let log={
                    ...
                    {
                        timeCnt++;
                         axios__default["default"].post('http://43.138.126.219:8000/api/ajaxstatus/new',log).then(res=>{
                        console.log(res);
                         });
                    }
